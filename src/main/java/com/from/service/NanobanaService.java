...
public class NanobanaService {
    ...
    public String generateImage(byte[] photoBytes, String mimeType,
        ...
        try {
            ...
            // contents (텍스트 + 이미지 순서로 전달)
            Map<String, Object> content = new HashMap<>();
            content.put("role", "user");
            content.put("parts", List.of(textPart, imagePart));

            // 응답에 이미지와 텍스트 모두 요청 (generationConfig 키는 camelCase)
     ...
     * Gemini REST API 는 JSON 키를 camelCase 로 반환하므로 "inlineData" 로 조회한다.
     *
     * @param responseBody RestTemplate 이 역직렬화한 Map
     * @return "data:image/png;base64,..." 형태의 Data URL
     */
    ...
    private String extractImageUrl(Map<String, Object> responseBody) {
        ...
        try {
            ...
            // Gemini REST API 응답은 camelCase 키("inlineData", "mimeType") 를 사용한다
