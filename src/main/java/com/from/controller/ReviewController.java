    ...
    public Map<String, Object> generate(
        ...
        try {
            ...
            String prompt = String.format("""
                당신은 독서 편지를 써주는 AI입니다.
                다음 책에 대해 미래의 나에게 보내는 독서 편지를 작성해주세요.
                ...
                조건:
                - 편지 형식으로 작성 (인사말로 시작, 마무리 인사로 끝)
                - 500자 내외로 작성
                - 책에서 얻은 교훈과 강조 내용을 중심으로
                - 미래의 나에게 따뜻하고 의미있는 메시지 전달
                - 날짜(%s)에 이 편지를 받는다는 설레임을 담아주세요
